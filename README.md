...
- Página única com seções: Hero, Sobre, Essência, Produtos, Galeria, Cuidados, Processo de Pedido, FAQ e Contato.
...
- Publicar a pasta `dist/` em host estático (Vercel, Netlify, GitHub Pages, Cloudflare Pages ou servidor web).
